...
@section('content')
        ...
        >
            <div class="mr-6">
                <h1 class="text-4xl font-semibold mb-2">Programs</h1>
                    ...
                    >
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    @if($program->image)
                                    <img class="w-10 h-10" src="{{ URL::asset('storage/' . $program->image) }}" alt="">
                                    @else
                                    No Image
                                    @endif
                                </td>
